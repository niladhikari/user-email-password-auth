  ...
  return (
    <div className="m-auto grid justify-center items-center hero min-h-screen bg-base-200 ">
      <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
        ...
        {
          registerError && <p className="text-red-600 text-sm font-semibold pb-4 text-center">{registerError}</p>
        }
        {
          registerSuccess && <p className="text-green-600 text-sm font-semibold pb-4 text-center">{registerSuccess}</p>
        }
      </div>
    </div>
  );
